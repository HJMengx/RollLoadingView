...
+ (void)Show{
    ...
    //    [loadingView HasSettingDuration];
...
- (void)AfterExecution:(CGFloat)delay WithOperation:(void (^)())completion{
...
- (UIView *)rollView{
    ...
    if(!_rollView){
        ...
        _rollView.backgroundColor = [UIColor colorWithRed:100 green:100 blue:100 alpha:1];
        //frame = (140.376 286.376; 94.2478 94.2478)
    }
...
- (void)InitLayer{
    ...
    CAShapeLayer* LineLeftlLayer = [CAShapeLayer layer];
    LineLeftlLayer.path = LineLeft.CGPath;
    LineLeftlLayer.strokeColor = [[UIColor lightGrayColor] CGColor];
    ...
    CAShapeLayer* LineRightlLayer = [CAShapeLayer layer];
    LineRightlLayer.path = LineRight.CGPath;
    LineRightlLayer.strokeColor = [[UIColor lightGrayColor] CGColor];
    ...
    [self InitAnimation:LineLeftlLayer ForKey:@"LineLeft"];
    [self InitAnimation:LineRightlLayer ForKey:@"LineRight"];
    
    [self.rollView.layer addSublayer:CircleRightLayer];
    [self.rollView.layer addSublayer:CircleLeftLayer];
    [self.rollView.layer addSublayer:LineRightlLayer];
    [self.rollView.layer addSublayer:LineLeftlLayer];
}
